...
class PreferencesProvider with ChangeNotifier {
  ...
  static const String twoFactorAuthenticationKey = 'two_factor_authentication_enabled';
  ...
  void _loadPreferences() {
    ...
    _twoFactorAuthenticationEnabled = _prefs.getBool(twoFactorAuthenticationKey) ?? false;
    notifyListeners();
  }
